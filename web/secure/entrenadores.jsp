...
<html>
    ...
    <body class="bg-dark">
        ...
        <div class="container-fluid p-5">
            <h3 class="text-white">Actuliza los entrenadores.</h3>
        ...
        <div class="contaier">
            <div class="from-group col-12 col-sm-8 offset-sm-2 text-center">
                <label class="font-weight-bold text-danger letratitulo" for="filtro">FILTRAR POR NOMBRE </label>
                <div class="row">
                    <c:if test="${entrenador.administrador}">
                        ...
                        <a class="btn btn-danger col-1 ml-3" href="altaEntrenador.jsp"><i class="fas fa-plus"></i></a>
                    </c:if>
                    <c:if test="${!entrenador.administrador}">
