    ...
    <body class="bg-dark">
        ...
        <section>
            ...
            <div class="container-fluid p-5">
                <h3 class="text-white">Aqui podras actulizar y gestionar la aplicacion.</h3>
            ...
            <div class="container-fluid p-sm-4">
                ...
                <a class=" text-white stretched-link bg-danger btn p-5 col-12 col-sm-10 offset-sm-1 letratitulo" style="font-size: 2rem" href="usuarios.jsp">USUARIOS</a>
                <a class=" text-white stretched-link bg-danger btn p-5 col-12 col-sm-10 offset-sm-1 letratitulo mt-5" style="font-size: 2rem" href="rutinas.jsp">RUTINAS</a>
                ...
                <a class=" text-white stretched-link bg-danger btn p-5 col-12 col-sm-10 offset-sm-1 letratitulo mt-5 mb-5" style="font-size: 2rem" href="entrenadores.jsp">ENTRENADORES</a>
            </div>
