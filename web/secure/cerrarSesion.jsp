    ...
    <body class="bg-dark">
                        ...
                        <div class="nav navbar-nav navbar-right">
                            <div class="dropdown container-fluid">
                                <ul class="nav navbar-nav ms-sm-5">
                                    <li><a href="../inicio.jsp" class="nav-item nav-link mx-sm-5" >Inicio</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <section>
            ...
            <div class="container-fluid p-5">
                <h3 class="text-white">Nos veremos pronto</h3>
                <h1 class="letratitulo text-danger">QUE NADA TE DETENGA !!</h1>
            </div>

            <div class="container-fluid p-sm-4">
                <h4 class="text-center text-white mb-5">Ud. Ha sido desconectado correctamente</h4>
                <p class="text-center text-white"><a href="../inicio.jsp" class="btn btn-info btn-lg p-3">Volver al Inicio</a></p>
            </div>
